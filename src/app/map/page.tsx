...
import { MapPin, Droplets, Waves } from "lucide-react";
...
const mockWaterSystems: WaterSystem[] = [
  {
    id: "des-moines-water",
    ...
    contaminants: [Contaminant.NITRATE, Contaminant.ARSENIC, Contaminant.FLUORIDE],
  },
  {
    ...
    contaminants: [Contaminant.NITRATE, Contaminant.PFAS, Contaminant.DBP],
  },
  {
    id: "lake-macbride",
